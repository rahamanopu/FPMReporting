                        ...
                        <form class="form-horizontal" action="<?php echo base_url().$action ?>" method="post">
                            ...
                            <div class="col-md-6">
                                <div class="form-group">
                                    <label for="Category" class="control-label col-sm-4">Distributor Code </label>
                                    <div class="col-sm-8">
                                    <label for="Category" class="control-label col-sm-4 text-primary"><b>
										<select name="distributorcode" class="form-control" required="">
