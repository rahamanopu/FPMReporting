        ...
        <div class="row">
            <div id="panel-1" class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url(); ?>learning/document-category-update/<?php echo $document_category[0]['DocumentCategoryID']; ?>" method="post" enctype="multipart/form-data">
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="Business" id="Business" class="form-control" required>
                                    ...
                                    <option <?php if ($document_category[0]['Business'] == $row['Business']) {
                                        echo "selected";
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="CategoryName" id="CategoryName" value="<?php echo $document_category[0]['CategoryName'];?>" autocomplete="off" required="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <select name="ActiveStatus" id="ActiveStatus" class="form-control" required>
                                    <?php
                                        if ($document_category[0]['ActiveStatus'] == "Y") {
                                    ?>
