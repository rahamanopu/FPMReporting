        ...
        <div class="row">
            <div id="panel-1" class="panel panel-default">
                ...
                <div class="panel-body">
                    <form action="<?php echo base_url(); ?>learning/document-store" method="post" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <select name="DocumentCategoryID" id="DocumentCategoryID" class="form-control" required>
                                    ...
                                    foreach ($document_category as $row){
                                        ?>
                                        <option value="<?php echo $row['DocumentCategoryID'];?>"><?php echo $row['CategoryName'];?></option>
                                        <?php
                                    }
                                    ?>
                                </select>
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <input type="text" class="form-control" name="DocumentTitle" id="DocumentTitle" value="" autocomplete="off" required="">
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
                        ...
                        <div class="col-md-3">
                            <div class="form-group">
                                ...
                                <textarea name="DocumentDescription" class="form-control" id="" required></textarea>
                            </div>
                        </div>
                        <div class="col-md-3">
                            <div class="form-group">
